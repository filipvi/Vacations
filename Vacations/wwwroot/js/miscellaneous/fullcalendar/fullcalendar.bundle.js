    ...
    */
    ...
    function isInteractionValid(interaction, calendar) {
        ...
        function isInteractionPropsValid(state, calendar, dateSpanMeta, filterConfig) {
            ...
            var otherEventStore = excludeInstances(state.eventStore, interaction.affectedEvents.instances); // exclude the subject events. 
    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.buildDayHeaderRow = function (dayDate) {
            var dateEnv = this.dateEnv;
            var mainFormat = core.createFormatter(this.opt('listDayFormat'));
            var altFormat = core.createFormatter(this.opt('listDayAltFormat'));
        ...
        TimeGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
            ...
            if (core.isMultiDayRange(eventRange.range)) {
                ...
                if (seg.isStart || seg.isEnd) {
                    ...
                    timeText = this._getTimeText(unzonedStart, unzonedEnd, allDay);
...
(function (global, factory) {
    ...
    */
    ...
    var EventDragging = /** @class */ (function (_super) {
                    ...
                    if (_this.validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var eventDropArg = __assign({}, transformed, {
                                el: ev.subjectEl, delta: _this.validMutation.startDelta, oldEvent: eventApi, event: new core.EventApi(// the data AFTER the mutation
        ...
        EventDragging.SELECTOR = '.fc-draggable, .fc-resizable';
