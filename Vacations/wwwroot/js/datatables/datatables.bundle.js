...
$.extend(true, $.fn.dataTable.defaults, {
	...
	*/
	...
	language: {
		...
		search: '<div class="input-group-text d-inline-flex width-3 align-items-center justify-content-center border-bottom-right-radius-0 border-top-right-radius-0 border-right-0"><i class="far fa-search"></i></div>',
		/* add search filter */
	...
	$.extend(
		altEditor.prototype,
		{
			...
			_openDeleteModal: function () {
				...
				$(selector).on('show.bs.modal', function () {
					var btns = '<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancel</button>' +
						'<button type="button"  data-content="remove" class="btn btn-danger" id="deleteRowBtn"><i class="far fa-times"></i> Delete</button>';
